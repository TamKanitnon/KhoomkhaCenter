    ...
    <v-card>
      <v-card-title justify-center class="mt-2">
        <v-row justify="center" class="mt-2">
          <span align="center" justify="center">Add Product test</span>
        </v-row>
      </v-card-title>
      <v-card-text>
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        const result = await this.addProduct(modifyProduct);
        console.log(result);
