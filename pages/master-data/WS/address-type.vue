<template>
  <div class="container">
    ...
    <h2 class="text-center mt-2 mb-4">Wholesale Address Type</h2>
    <div class="row my-5">
      <v-row class="pa-2">
        <v-col cols="12">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Name', value: 'AddressTypeName', align: 'center' },
        { text: 'Code ', value: 'AddressTypeCode', align: 'center' },
  ...
  computed: {
    ...mapGetters('master-data', {
      addressTypeList: 'WSAddressTypes',
    }),
  },
  watch: {
    addressTypeList(newValue) {
      this.totalItems = newValue.length;
    },
  },
  created() {
    this.totalItems = this.addressTypeList.length; // Set totalItems based on the already fetched data
  },
  methods: {
