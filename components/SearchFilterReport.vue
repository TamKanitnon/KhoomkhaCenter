      ...
      <v-col cols="12" md="6" lg="6">
        <v-row>
          ...
          <v-col cols="8" class="d-flex">
            <v-btn v-if="showLastWeek" color="success" class="mx-1" dark @click="lastWeek()"
              ><v-icon left>mdi-menu-left</v-icon>อาทิตย์</v-btn
...
export default {
  ...
  methods: {
    ...
    lastWeek() {
      let response = this.setLastweek();
      this.$emit("lastweek", response);
    },
    toyesterday() {
